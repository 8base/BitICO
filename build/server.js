...
module.exports = /** *** */ (function(modules) {
  ...
  /** *** */ {
    ...
    /** */ './node_modules/css-loader/index.js?{"importLoaders":1,"sourceMap":true,"modules":true,"localIdentName":"[name]-[local]-[hash:base64:5]","minimize":false}!./node_modules/postcss-loader/lib/index.js?{"config":{"path":"./tools/postcss.config.js"}}!./src/routes/error/ErrorPage.css': /** */ function(
      module,
      exports,
      __webpack_require__,
    ) {
      ...
      exports.push([
        ...
        '',
        {
          version: 3,
          sources: [
            '/Users/andreianisimov/projects/blockchain/rsk/icoX/src/routes/error/ErrorPage.css',
          ],
          names: [],
          mappings:
...
*/
    ...
    /** */ './src/components/Html.js': /** */ function(
      ...
      const _jsxFileName =
        '/Users/andreianisimov/projects/blockchain/rsk/icoX/src/components/Html.js';
                      ...
                      'script',
                      {
                        dangerouslySetInnerHTML: {
                          __html: 'window.App='.concat(
                            __WEBPACK_IMPORTED_MODULE_2_serialize_javascript___default()(
                              app,
                            ),
                          ),
                        },
                        ...
                        'script',
                        {
                          dangerouslySetInnerHTML: {
                            __html: `window.ga=function(){ga.q.push(arguments)};ga.q=[];ga.l=+new Date;${"ga('create','".concat(
                              __WEBPACK_IMPORTED_MODULE_3__config___default.a
    ...
    /** */ './src/data/models/index.js': /** */ function(
      ...
      __WEBPACK_IMPORTED_MODULE_1__User__['a' /* default */].hasMany(
        __WEBPACK_IMPORTED_MODULE_2__UserLogin__['a' /* default */],
        {
          foreignKey: 'userId',
          as: 'logins',
          onUpdate: 'cascade',
      ...
      __WEBPACK_IMPORTED_MODULE_1__User__['a' /* default */].hasMany(
        __WEBPACK_IMPORTED_MODULE_3__UserClaim__['a' /* default */],
        {
          foreignKey: 'userId',
          as: 'claims',
          onUpdate: 'cascade',
      ...
      __WEBPACK_IMPORTED_MODULE_1__User__['a' /* default */].hasOne(
        __WEBPACK_IMPORTED_MODULE_4__UserProfile__['a' /* default */],
        {
          foreignKey: 'userId',
          as: 'profile',
          onUpdate: 'cascade',
      ...
      function sync() {
        return __WEBPACK_IMPORTED_MODULE_0__sequelize__[
          'a' /* default */
        ].sync.apply(
          __WEBPACK_IMPORTED_MODULE_0__sequelize__['a' /* default */],
          arguments,
        );
      }
    ...
    /** */ './src/data/queries/news.js': /** */ function(
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_node_fetch__ = __webpack_require__(
        'node-fetch',
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_node_fetch___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_1_node_fetch__,
      );
      ...
      const news = {
        ...
        resolve: function resolve() {
          ...
          if (
            ...
            lastFetchTask = __WEBPACK_IMPORTED_MODULE_1_node_fetch___default()(
              url,
            )
                        ...
                        while (1) {
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              _context.next = 3;
                              return __WEBPACK_IMPORTED_MODULE_2__data_models__[
                                'c' /* UserLogin */
                              ].findOne({
                                attributes: ['name', 'key'],
                                where: {
    ...
    /** */ './src/routes/error/ErrorPage.js': /** */ function(
      ...
      const _jsxFileName =
        '/Users/andreianisimov/projects/blockchain/rsk/icoX/src/routes/error/ErrorPage.js';
    ...
    /** */ './src/routes/error/index.js': /** */ function(
      ...
      const _jsxFileName =
        '/Users/andreianisimov/projects/blockchain/rsk/icoX/src/routes/error/index.js';
    ...
    /** */ './src/server.js': /** */ function(
      ...
      const _jsxFileName =
        '/Users/andreianisimov/projects/blockchain/rsk/icoX/src/server.js';
                ...
                _context => {
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        now = new Date();
                        RSKService = __webpack_require__(
                          './src/services/RSKService.js',
                        ).default;
                        console.log('starting...');
                        rskService = new RSKService(
                          'http://localhost:4444',
                          '0x0e082742330d4a06ef127ca89f78f7283141c572',
                          '923b6888e648c22a69fbb4afe985fe90d61c6c3f5d84b62025e358bb8fcf1776',
                        );
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      case 0:
                        ...
                        context = {
                          ...
                          fetch: Object(
                            ...
                            {
                              baseUrl:
                                __WEBPACK_IMPORTED_MODULE_21__config___default.a
                                  .api.serverUrl,
                        ...
                        _context2.next = 5;
                        return __WEBPACK_IMPORTED_MODULE_17__router__.default.resolve(
                          _extends({}, context, {
                            pathname: req.path,
                            query: req.query,
                          }),
                      ...
                      case 9:
                        ...
                        if (route.chunks) {
                          (_data$scripts = data.scripts).push.apply(
                            _data$scripts,
                            _toConsumableArray(
                              route.chunks.map(
                                chunk =>
                                  __WEBPACK_IMPORTED_MODULE_20__assets_json___default
                                    .a[chunk].js,
                              ),
                            ),
                          );
                        ...
                        html = __WEBPACK_IMPORTED_MODULE_9_react_dom_server___default.a.renderToStaticMarkup(
                          __WEBPACK_IMPORTED_MODULE_8_react___default.a.createElement(
      ...
      if (false) {
        promise.then(() => {
          app.listen(config.port, () => {
            console.info(
              'The server is running at http://localhost:'.concat(
                config.port,
                '/',
              ),
            );
    ...
    /** */ './src/services/RSKService.js': /** */ function(
      module,
      __webpack_exports__,
      __webpack_require__,
    ) {
      ...
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_web3__ = __webpack_require__(
        'web3',
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_0_web3___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_0_web3__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_truffle_contract__ = __webpack_require__(
        'truffle-contract',
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_1_truffle_contract___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_1_truffle_contract__,
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_2_bignumber_js__ = __webpack_require__(
        'bignumber.js',
      );
      /* harmony import */ const __WEBPACK_IMPORTED_MODULE_2_bignumber_js___default = __webpack_require__.n(
        __WEBPACK_IMPORTED_MODULE_2_bignumber_js__,
      );
      function _classCallCheck(instance, Constructor) {
        if (!(instance instanceof Constructor)) {
          throw new TypeError('Cannot call a class as a function');
      ...
      const toWei = function toWei(etherValue) {
        return new __WEBPACK_IMPORTED_MODULE_2_bignumber_js___default.a(
          etherValue,
        ).shift(WEI_DECIMAL_PLACES);
      };

      const toEther = function toEther(weiValue) {
        return new __WEBPACK_IMPORTED_MODULE_2_bignumber_js___default.a(
          weiValue,
        ).shift(-WEI_DECIMAL_PLACES);
      };

      var RSKService = function RSKService(
        providerURL,
        ownerAddress,
        ownerPrivateKey,
      ) {
        ...
        Object.defineProperty(this, 'deployCrowdsale', {
          ...
          value: function value(_ref) {
            let tokenName = _ref.tokenName,
              ...
              onSent = _ref.onSent;
            return new Promise((resolve, reject) => {
              const Crowdsale = _this.web3.eth.contract(CROWDSALE_CONFIG.abi);

              const crowdsaleInstance = Crowdsale.new(
                tokenName,
                tokenSymbol,
        ...
        Object.defineProperty(this, 'loadTokenAt', {
          ...
          writable: true,
          value: function value(contractAddress) {
            const Token = _this.web3.eth.contract(TOKEN_CONFIG.abi);
        ...
        this.provider = new __WEBPACK_IMPORTED_MODULE_0_web3___default.a.providers.HttpProvider(
          providerURL,
        );
        this.web3 = new __WEBPACK_IMPORTED_MODULE_0_web3___default.a(
          this.provider,
        );
    ...
    /** */ 'bignumber.js': /** */ function(module, exports) {
    ...
    /** */ 'truffle-contract': /** */ function(module, exports) {
